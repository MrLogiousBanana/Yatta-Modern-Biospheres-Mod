...
public class BiospheresChunkGenerator extends ChunkGenerator {
	...
	public java.util.concurrent.CompletableFuture<net.minecraft.world.chunk.Chunk> populateBiomes(net.minecraft.world.gen.noise.NoiseConfig noiseConfig, net.minecraft.world.gen.chunk.Blender blender, net.minecraft.world.gen.StructureAccessor structureAccessor, net.minecraft.world.chunk.Chunk chunk) {
		if (this.actualSeed == null) {
			...
			if (s == 0) {
				try {
					long rsSeed = noiseConfig.getOrCreateRandomDeriver(net.minecraft.util.Identifier.of("biospheres", "seed")).split(0, 0, 0).nextLong();
	...
	public void makeBridges(BlockPos pos, BlockPos centerPos, BlockPos[] nesw, Chunk chunk, BlockPos.Mutable current, double sRadius, OreSphere[] oreSpheres) {
