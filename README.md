...
### Authors
1. **MrLogiousBanana** (Project Lead, Overhaul & Modernization)
2. **Risugami** (Creator of the original Biospheres concept)
3. **FarlanderCraft**, **Coolsa**, **zraffleticket** (Previous maintainers)
4. **Gemini** (AI Pair Programmer 🤖✨)
...
* **1.20.1**: Fabric и Forge
* **1.20.4**: Fabric
* **1.21.1**: Fabric и NeoForge

### Авторы
1. **MrLogiousBanana** (Руководитель проекта, полная переработка и модернизация)
