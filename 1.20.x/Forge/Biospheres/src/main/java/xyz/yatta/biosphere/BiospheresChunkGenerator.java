...
public class BiospheresChunkGenerator extends ChunkGenerator {
	...
	private BlockState randomOreBlock(int x, int y, int z) {
		...
		java.util.Optional<net.minecraft.core.HolderSet.Named<net.minecraft.world.level.block.Block>> oresC = net.minecraft.core.registries.BuiltInRegistries.BLOCK.getTag(net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BLOCK, new net.minecraft.resources.ResourceLocation("c", targetPath)));
		java.util.Optional<net.minecraft.core.HolderSet.Named<net.minecraft.world.level.block.Block>> oresForge = net.minecraft.core.registries.BuiltInRegistries.BLOCK.getTag(net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BLOCK, new net.minecraft.resources.ResourceLocation("forge", targetPath)));
		...
		if (oresForge.isPresent()) {
			for (net.minecraft.core.Holder<net.minecraft.world.level.block.Block> holder : oresForge.get()) {
				if (!allOres.contains(holder.value())) allOres.add(holder.value());
			}
		}
					...
					for (int y = centerPos.getY() - (int) sphereHeight; y <= centerPos.getY() + sphereHeight; y++) {
						...
						if (blockState.equals(this.defaultBlock) && !biome.is(BiomeTags.IS_NETHER)) {
							...
							if (depth < 4) {
								...
								boolean isSandy = biome.is(net.minecraft.world.level.biome.Biomes.DESERT) || biome.is(net.minecraft.tags.BiomeTags.IS_BEACH) || biome.is(net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BIOME, new net.minecraft.resources.ResourceLocation("c", "sandy"))) || biome.is(net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BIOME, new net.minecraft.resources.ResourceLocation("biospheres", "surface_sand")));
								boolean isRedSand = biome.is(net.minecraft.tags.BiomeTags.IS_BADLANDS) || biome.is(net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BIOME, new net.minecraft.resources.ResourceLocation("biospheres", "surface_red_sand")));
								boolean isMushroom = biome.is(net.minecraft.world.level.biome.Biomes.MUSHROOM_FIELDS) || biome.is(net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BIOME, new net.minecraft.resources.ResourceLocation("biospheres", "surface_mycelium")));
								boolean isMuddy = biome.is(net.minecraft.world.level.biome.Biomes.SWAMP) || biome.is(net.minecraft.world.level.biome.Biomes.MANGROVE_SWAMP) || biome.is(net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BIOME, new net.minecraft.resources.ResourceLocation("biospheres", "surface_mud")));
	...
	private boolean isCaveBiome(net.minecraft.core.Holder<net.minecraft.world.level.biome.Biome> biome) {
		net.minecraft.tags.TagKey<Biome> CAVES_TAG = net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BIOME, new net.minecraft.resources.ResourceLocation("c", "caves"));
		net.minecraft.tags.TagKey<Biome> IS_CAVE_TAG = net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BIOME, new net.minecraft.resources.ResourceLocation("c", "is_cave"));
	...
	public void createStructures(net.minecraft.core.RegistryAccess registryManager, net.minecraft.world.level.chunk.ChunkGeneratorStructureState placementCalculator, net.minecraft.world.level.StructureManager structureAccessor, net.minecraft.world.level.chunk.ChunkAccess chunk, net.minecraft.world.level.levelgen.structure.templatesystem.StructureTemplateManager structureTemplateManager) {
		...
		if (Math.floorDiv(cxBase, 16) == chunkPos.x && Math.floorDiv(czBase, 16) == chunkPos.z) {
			int cy = this.getNearestCenterSphere(new net.minecraft.core.BlockPos(cxBase, 0, czBase)).getY();
			net.minecraft.core.Holder<net.minecraft.world.level.biome.Biome> centerBiome = this.biomeSource.getNoiseBiome(net.minecraft.core.QuartPos.fromBlock(cxBase), net.minecraft.core.QuartPos.fromBlock(cy), net.minecraft.core.QuartPos.fromBlock(czBase), placementCalculator.randomState().sampler());
