...
public class BiospheresBiomeSource extends BiomeSource {
	...
	private void initBiomes() {
		if (this.availableBiomes == null) {
			...
			net.minecraft.tags.TagKey<Biome> CAVES_TAG = net.minecraft.tags.TagKey.create(Registries.BIOME, new net.minecraft.resources.ResourceLocation("c", "caves"));
			net.minecraft.tags.TagKey<Biome> IS_CAVE_TAG = net.minecraft.tags.TagKey.create(Registries.BIOME, new net.minecraft.resources.ResourceLocation("c", "is_cave"));
